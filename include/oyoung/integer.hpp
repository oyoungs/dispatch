...
template <> struct  is_supported_package<std::int8_t > { constexpr static bool value = true; };
template <> struct  is_supported_package<std::uint8_t > { constexpr static bool value = true; };
template <> struct  is_supported_package<std::int16_t > { constexpr static bool value = true; };
template <> struct  is_supported_package<std::uint16_t > { constexpr static bool value = true; };
template <> struct  is_supported_package<std::int32_t > { constexpr static bool value = true; };
template <> struct  is_supported_package<std::uint32_t > { constexpr static bool value = true; };
template <> struct  is_supported_package<std::int64_t > { constexpr static bool value = true; };
template <> struct  is_supported_package<std::uint64_t > { constexpr static bool value = true; };
template <> struct  is_supported_package<float > { constexpr static bool value = true; };
template <> struct  is_supported_package<double > { constexpr static bool value = true; };
template <> struct  is_supported_package<long double > { constexpr static bool value = true; };
